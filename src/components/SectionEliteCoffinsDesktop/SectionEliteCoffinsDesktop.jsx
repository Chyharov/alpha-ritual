...
const SectionEliteCoffinsDesktop = ({
  ...
  eliteTitleForModalWindow
}) => {
  return (
    <section className={s.sectionEliteCoffinsDesktop}>
        <div className={`container ${s.eliteCoffinsContainerDesktop}`}>
          <div className={s.eliteCoffinsContainer}>
            ...
            <GalleryWithTitleAndButtonMoreDetails
              ...
              titleForModalWindow={eliteTitleForModalWindow}
...
export default SectionEliteCoffinsDesktop;
