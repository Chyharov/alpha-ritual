    ...
    <section className={s.sectionRitualServices} id='services'>
      <div className="container">
        <div className={s.ritualServices__container}>
          ...
          <p className="description" style={{ textAlign: 'center', marginBottom: '20px' }}>Одне із основних видів похоронних послуг, комплексну організацію яких ми повністю беремо він. Транспортування померлого по Києву до місця проведення церемонії прощання та після неї на цвинтар чи крематорій має відповідати ситуації та статусу покійного.</p>
