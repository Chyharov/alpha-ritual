          ...
          <div className={'container ' + s.artificialWreathsContainer}>
            <div className={s.artificialWreathsDescriptionContainer}>
              ...
              <h2 className="title">Як вибрати ритуальний вінок зі штучних квітів</h2>
                ...
                <p className="description" style={{marginBottom: '20px' }}>Флористи похоронного будинку «Альфа та Омега» складають будь-які траурні композиції з ботанічних копій різних видів квітів та рослин. Букети, надгробні квіткові монограми та похоронні вінки складаються з сучасного флористичного матеріалу, який природно виглядає і коштує недорого.</p>
