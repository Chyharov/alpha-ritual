      ...
      <div className={'container ' + s.footerContainer}>
        <div className={s.navigationContainer}>
          ...
          <nav className={s.footerNavigation}>
            <ul className={s.footerNavList}>
              <Link to="/">
                <li className={s.footerNavListItem}>Головна</li>
              </Link>
              <Link to="/about">
                <li className={s.footerNavListItem}>Про компанію</li>
              </Link>
              <Link to="/ritualgoods">
                <li className={s.footerNavListItem}>Ритуальні товари</li>
              </Link>
              <Link to="/ritualtransport">
                <li className={s.footerNavListItem}>Ритуальний транспорт</li>
              </Link>
              <Link to="/ritualservices">
                <li className={s.footerNavListItem}>Ритуальні послуги</li>
              </Link>
              <Link to="/additionalservices">
                <li className={s.footerNavListItem}>Додаткові послуги</li>
              </Link>
            </ul>
          </nav>
        </div>
        ...
        <address className={s.address}>
          ...
          <ul className={s.addressList}>
            ...
            >
              <li
                style={{ padding: '4px 8px 8px', marginBottom: '8px' }}
                className={s.addressListItem}
              >
            ...
            <a href="tel:+380672459505">
              <li
                ...
                className={s.addressPhoneListItemLast}
              >
                +38 (067) 245 95 05
              </li>
            </a>
            <a href="tel:+380442322408">
              <li
                style={{ padding: '4px 8px' }}
                className={s.addressPhoneListItem}
              >
                +38 (044) 232 24 08
              </li>
            </a>
        ...
        <div className={s.copyrightDescriptionContainer}>
          <p className={s.copyrightDescription}>
            АЛЬФА - Похоронний дім © 2023
          </p>{' '}
          <p className={s.copyrightDescription}>Всі права захищені.</p>
        </div>
      </div>
