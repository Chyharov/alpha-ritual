...
const RitualCarParBlackMercedesPhoto = [
  { id: 1, src: require('../../images/blackMercedes/blackMercedesUpdate.webp'), alt: 'Зображення 1', width: '280', height: '210' },
  { id: 2, src: require('../../images/blackMercedes/blackMercedesUpdate2.webp'), alt: 'Зображення 2', width: '280', height: '210' },
  { id: 3, src: require('../../images/blackMercedes/blackMercedesUpdate3.webp'), alt: 'Зображення 3', width: '150', height: '150' },
  { id: 4, src: require('../../images/blackMercedes/blackMercedesUpdate4.webp'), alt: 'Зображення 4', width: '280', height: '210' },
  { id: 5, src: require('../../images/blackMercedes/blackMercedesUpdate5.webp'), alt: 'Зображення 5', width: '280', height: '210' },
  { id: 6, src: require('../../images/blackMercedes/blackMercedesUpdate6.webp'), alt: 'Зображення 6', width: '280', height: '210' },
  { id: 7, src: require('../../images/blackMercedes/blackMercedesUpdate7.webp'), alt: 'Зображення 7', width: '280', height: '210' },
  { id: 8, src: require('../../images/blackMercedes/blackMercedesUpdate8.webp'), alt: 'Зображення 8', width: '280', height: '210' },
  { id: 9, src: require('../../images/blackMercedes/blackMercedesUpdate9.webp'), alt: 'Зображення 9', width: '280', height: '210' },
  { id: 10, src: require('../../images/blackMercedes/blackMercedesUpdate10.webp'), alt: 'Зображення 10', width: '280', height: '210' },
  { id: 11, src: require('../../images/blackMercedes/blackMercedesUpdate11.webp'), alt: 'Зображення 11', width: '280', height: '210' },
  { id: 12, src: require('../../images/blackMercedes/blackMercedesUpdate12.webp'), alt: 'Зображення 12', width: '280', height: '210' }
];
